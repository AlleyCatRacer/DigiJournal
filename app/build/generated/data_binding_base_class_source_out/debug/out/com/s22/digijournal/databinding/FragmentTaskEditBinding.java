...
public final class FragmentTaskEditBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText deadlineText;
  ...
  private FragmentTaskEditBinding(@NonNull FrameLayout rootView, @NonNull Button backButton,
      @NonNull TextView deadlineLabel, @NonNull EditText deadlineText,
      @NonNull TextView detailLabel, @NonNull TextInputEditText detailText,
      @NonNull Button editButton, @NonNull TextView taskNameLabel,
  ...
  public static FragmentTaskEditBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.deadline_text;
      EditText deadlineText = ViewBindings.findChildViewById(rootView, id);
      ...
      return new FragmentTaskEditBinding((FrameLayout) rootView, backButton, deadlineLabel,
          deadlineText, detailLabel, detailText, editButton, taskNameLabel, title);
    }
