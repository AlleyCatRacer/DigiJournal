...
public final class FragmentTaskDetailsBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView taskDetailsDesc;
  ...
  @NonNull
  public final TextView taskDetailsIDLabel;

  @NonNull
  public final TextView taskDetailsTaskName;

  private FragmentTaskDetailsBinding(@NonNull ScrollView rootView,
      @NonNull TextView deadlineTextView, @NonNull TextView taskDetailsDeadlineLabel,
      @NonNull TextView taskDetailsDesc, @NonNull TextView taskDetailsDetailLabel,
      @NonNull Button taskDetailsEditButton, @NonNull TextView taskDetailsIDLabel,
    ...
    this.taskDetailsIDLabel = taskDetailsIDLabel;
  ...
  public static FragmentTaskDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.task_details_desc;
      TextView taskDetailsDesc = ViewBindings.findChildViewById(rootView, id);
      if (taskDetailsDesc == null) {
        break missingId;
      }
      ...
      id = R.id.task_details_ID_label;
      TextView taskDetailsIDLabel = ViewBindings.findChildViewById(rootView, id);
      if (taskDetailsIDLabel == null) {
        break missingId;
      }
      ...
      return new FragmentTaskDetailsBinding((ScrollView) rootView, deadlineTextView,
          taskDetailsDeadlineLabel, taskDetailsDesc, taskDetailsDetailLabel, taskDetailsEditButton,
          taskDetailsIDLabel, taskDetailsTaskName);
    }
